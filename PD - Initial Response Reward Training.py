...
class Experiment_Staging(FloatLayout):
    ...
    def id_entry(self):
        ...
        self.current_task = 'PD - Initial Response Training - '
    ...
    def initiation_detected(self,*args):
        ...
        self.response_correct() # Start Presentation Delay
    ...
    def response_correct(self, *args):
        ...
        self.lat = self.image_touch_time - self.initiation_start_time #Time to hit screen
    ...
    def response_incorrect(self, *args):
        ...
        self.lat = self.image_touch_time - self.initiation_start_time # Get Latency to Respond
    ...
    def end_iti(self,*args):
        ...
        if ((self.current_time - self.start_iti_time) >= self.iti_time) and self.feedback_displayed == False: # When ITI is complete
            ...
            if self.time_elapsed < self.max_time: # If Time is below max, continue
                self.delay_hold_button.bind(on_press=self.initiation_detected)
